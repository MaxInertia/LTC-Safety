...
public final class ConcernData extends com.google.api.client.json.GenericJson {
   ...
   */
  public ConcernData setActionsTaken(String actionsTaken) {
   ...
   */
  public ConcernData setConcernNature(String concernNature) {
   ...
   */
  public ConcernData setDescription(String description) {
